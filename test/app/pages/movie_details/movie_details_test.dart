...
Future<void> prepareMovieDetailsWidget(
  ...
  final utils = MovieDetailsUtils(mockAppParams, mockDateTimeReader);
  await prepareWidget(tester, language: language, widgetBuilder: () => MovieDetailsView(title, budget, revenue, utils));
}
